...
def recover_stream_plan(evaluations, current_plan, opt_evaluations, goal_expression, domain, node_from_atom,
    ...
    #print("[Meiying::plan_streams::recover_stream_plan] ~~~~~~~~1. stream_plan~~~~~~~~")
    #print(stream_plan)      
    ...
    #print("[Meiying::plan_streams::recover_stream_plan] ~~~~~~~~2. stream_plan~~~~~~~~")
    #print(stream_plan)     
    ...
    #print("[Meiying::plan_streams::recover_stream_plan] ~~~~~~~~3. stream_plan~~~~~~~~")
    #print(stream_plan)     
    ...
    #print("[Meiying::plan_streams::recover_stream_plan] ~~~~~~~~4. stream_plan~~~~~~~~")
    #print(stream_plan)     
    ...
    #print("[Meiying::plan_streams::recover_stream_plan] ~~~~~~~~5. stream_plan~~~~~~~~")
    #print(stream_plan)     
    ...
    #print("[Meiying::plan_streams::recover_stream_plan] ~~~~~~~~6. stream_plan~~~~~~~~")
    #print(stream_plan)     
    ...
    #print("[Meiying::plan_streams::recover_stream_plan]::1. preimage_facts: ")
    #for fact in preimage_facts:
        #print("\t", fact)
    for negative_result in negative_plan: # TODO: function_plan
        preimage_facts.update(negative_result.get_certified())
    #print("[Meiying::plan_streams::recover_stream_plan]::2. preimage_facts: ")
    #for fact in preimage_facts:
        #print("\t", fact)    
    ...
    #print("[Meiying::plan_streams::recover_stream_plan]::3. preimage_facts: ")
    #for fact in preimage_facts:
        #print("\t", fact)      
    #print("[Meiying::plan_streams::recover_stream_plan] ~~~~~~~~stream_plan~~~~~~~~")
    #print(stream_plan)
    #print("[Meiying::plan_streams::recover_stream_plan] ~~~~~~~~3. eager_plan~~~~~~~~")
    #print(eager_plan)
...
def solve_optimistic_sequential(domain, stream_domain, applied_results, all_results,
    ...
    #print("[Meiying::plan_streams::solve_optimistic_sequential] node_from_atom")
    #print(node_from_atom)
    
    #print("[Meiying::plan_streams::solve_optimistic_sequential] opt_evaluations")
    #print(opt_evaluations)
    
    #print("[Meiying::plan_streams::solve_optimistic_sequential] all_results")
    #print(all_results)
    
    #print("[Meiying::plan_streams::solve_optimistic_sequential] goal_expression")
    ...
    #print("[Meiying::plan_streams::solve_optimistic_sequential] sas_task")
    #print(sas_task)    
...
def plan_streams(evaluations, goal_expression, domain, all_results, negative, effort_weight, max_effort,
                 simultaneous=False, reachieve=True, replan_actions=set(), is_meiying_condition=False, **kwargs):
    ...
    #print("[Meiying::plan_streams::plan_streams] evaluations")
    #print(evaluations)
    
    #print("[Meiying::plan_streams::plan_streams] goal_expression")
    #print(goal_expression)
    
    #print("[Meiying::plan_streams::plan_streams] all_results")
    #print(all_results)
    ...
    #import inspect
    #print("[Meiying::plan_streams] stacks")
    ...
    print("Meiying::action_instances")
    if action_instances:
    ...
    replan_step = min([step+1 for step, action in enumerate(action_plan)
    ...
    #if is_meiying_condition:
        ## evaluations, stream_plan, opt_evaluations, goal_expression, stream_domain, node_from_atom, action_instances, axiom_plans, negative, replan_step
        #print("[Meiying::plan_streams] is_meiying_condition: ", is_meiying_condition)
        #print("[Meiying::plan_streams] action_instances (pose-processing): ")
        #if action_instances:
            #for action_instance in action_instances:
                #print("\t", action_instance)        
        #print("Instantiated:")
        ...
        #print("replan_step")
        #print(replan_step)
        ## each action is an instance of the class PropositionalAction
        #for action_instance in action_instances:
            #action_preconditions = action_instance.precondition
            #action_name = action_instance.name[1:-1].split()[0] # remove the "(" and ")"
            #print("\t", action_instance)
            #if action_name in ["pick"]:
                #body = None
                #pose = None
                #print("\tvar_mapping:")
                #print(action_instance.var_mapping)
                #for precondition in action_preconditions:
                    #print("\t\tprecondition:", precondition)
                    #print("\t\tprecondition type:", precondition.__name__)
                    #predicate = precondition.predicate
                    #args = precondition.args
                    #if predicate == "atpose":
                        #body, pose = args[0], args[1]
                        #break
                #print("\t found pick predicate and args: ", body, pose)
                ## Meiying: TODO
    ...
    try:
        ...
        print("[Meiying::plan_streams] Exception raised: ")
        print(e)
        return OptSolution(FAILED, FAILED, cost)
