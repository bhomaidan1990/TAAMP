(define (domain pick-and-place)
  ...
  (:predicates
    ...
    (Pose ?o ?p)
    (PullToolGoalPose ?o ?p ?to)
    (PushToolGoalPose ?o ?p ?to)
    (ValidGrasp ?o ?p ?q)
    (Grasp ?o ?g)
    (PullConfigKin ?o ?p1 ?p2 ?p3 ?to ?top1 ?g ?top ?q1 ?q2 ?t)
    (PullConfig ?o ?p1 ?p2 ?to ?g)
    (PushConfigKin ?o ?p1 ?p2 ?p3 ?to ?top1 ?g ?top ?q1 ?q2 ?t)
  ...
  (:action push
    :parameters (?o ?p1 ?p2 ?p3 ?to ?top1 ?g ?q1 ?q2 ?top ?t)
    :precondition (and (AtPose ?o ?p1)
                       (PushFeasible ?o ?to ?p1)
                       (Manipulanda ?o)
                       (PushToolGoalPose ?o ?p2 ?to)
                       (PushConfigKin ?o ?p1 ?p2 ?p3 ?to ?top1 ?g ?top ?q1 ?q2 ?t)
                       (AtGrasp ?to ?g)
                       (AtGraspPose ?to ?top1 ?q1)
                       (PushTool ?to)
  ...
  (:derived (UnsafePull ?o ?p1 ?p2 ?to ?g)
    (exists (?o2 ?p22) (and (Pose ?o ?p1) (Pose ?o ?p2)
                            (PullConfig ?o ?p1 ?p2 ?to ?g)
                            (PushTool ?to) (Movable ?o2) (Manipulanda ?o)
  ...
  (:derived (UnsafePullTraj ?o ?to ?t)
    (exists (?o2 ?p2) (and (Traj ?t) (Pose ?o2 ?p2)
                           (PullTool ?to) (Manipulanda ?o) (Movable ?o2)
  ...
  (:derived (UnsafePushTraj ?o ?to ?t)
    (exists (?o2 ?p2) (and (Traj ?t) (Pose ?o2 ?p2)
                           (PushTool ?to) (Manipulanda ?o) (Movable ?o2)
                           (not (= ?o ?o2)) (not (= ?to ?o2)) (not (= ?o ?to))
