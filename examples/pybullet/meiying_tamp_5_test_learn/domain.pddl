(define (domain pick-and-place)
  ...
  (:action move_holding
    ...
    :precondition (and ;(MoveFeasible ?o ?p1 ?p2 ?q1 ?q2)
  ...
  (:action pick
    :parameters (?o ?r ?f ?p1 ?p2 ?g ?q ?o2 ?p21 ?t)
    :precondition (and (AtPose ?o2 ?p21)
                       (not (= ?o ?o2))
                       (Movable ?o2)
                       (PickFeasible ?o ?r ?f ?p1 ?o2 ?p21)
                       (Kin ?o ?p1 ?p2 ?g ?q ?t)
  ...
  (:action place
    :parameters (?o ?s ?r ?p1 ?p2 ?g ?q ?o2 ?p21 ?t)
    :precondition (and (AtPose ?o2 ?p21)
                       (not (= ?o ?o2))
                       (not (= ?s ?r))
                       (Movable ?o2)
                       (PlaceFeasible ?o ?s ?r ?o2 ?p21)
                       (PickRegion ?o ?s)
