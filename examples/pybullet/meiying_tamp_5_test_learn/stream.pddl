(define (stream kuka-tamp)
  ...
  (:stream test-pick-feasible
    :inputs (?o ?r ?f ?p ?o1 ?p1)
    :domain (and (Pose ?o ?p) (Pose ?o1 ?p1) (Floor ?f) (Supported ?o ?p ?r) (Region ?r) (Different ?o ?o1))
    :certified (PickFeasible ?o ?r ?f ?p ?o1 ?p1)
  )
  (:stream test-place-feasible
    :inputs (?o ?s1 ?r ?o1 ?p1)
    :domain (and (Pose ?o1 ?p1) (Stackable ?o ?r) (Region ?s1) (Movable ?o1) (Different ?o ?o1))
