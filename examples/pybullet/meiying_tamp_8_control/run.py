...
from examples.pybullet.utils.pybullet_tools.kuka_primitives import BodyPose, BodyConf, Command, get_grasp_gen, \
    ...
    get_tool_motion_gen, get_cfree_tool_pose_test, get_cfree_tool_traj_test, get_pull_tool_goal_gen
...
def pddlstream_from_problem(robot, body_path, tool_grasp_pose={}, contact_poses={}, movable=[], pull_tool=None, push_tool=None, teleport=False, grasp_name='top'):
    ...
    stream_map = {
        ...
        'sample-tool-goal': from_gen_fn(get_pull_tool_goal_gen(fixed, movable)),
...
def load_world():
    ...
    return robot, body_names, movable_bodies, body_path, pull_tool, push_tool, contact_poses, tool_grasp_pose
...
def main():
    ...
    robot, names, movable, body_path, pull_tool, push_tool, contact_poses, tool_grasp_pose = load_world()
    print('Objects:', names)
    saver = WorldSaver()

    problem = pddlstream_from_problem(robot, body_path, tool_grasp_pose=tool_grasp_pose, contact_poses=contact_poses, movable=movable, pull_tool=pull_tool, push_tool=push_tool, teleport=args.teleport)
