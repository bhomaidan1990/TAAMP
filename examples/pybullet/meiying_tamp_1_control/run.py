...
def pddlstream_from_problem(robot, body_path, movable=[], teleport=False, grasp_name='top'):
...
def load_world():
    ...
    return robot, body_names, movable_bodies, body_path
...
def main():
    ...
    robot, names, movable, body_path = load_world()
    print('Objects:', names)
    saver = WorldSaver()

    problem = pddlstream_from_problem(robot, body_path, movable=movable, teleport=args.teleport)
