...
from examples.pybullet.utils.pybullet_tools.utils import WorldSaver, connect, dump_body, get_pose, set_pose, Pose, \
    ...
    BLOCK_URDF, SHORT_SMALL_BLOCK_URDF, DUCK_URDF, get_configuration, SINK_URDF, STOVE_URDF, load_model, is_placement, get_body_name, \
...
def pddlstream_from_problem(robot, body_path, grouping, surface, movable=[], teleport=False, grasp_name='top'):
    ...
    place_file_path = "tamp_5_place.json"
...
def load_world():
    ...
    #initial_index_grouping =[[sink, radish_1, radish_2, radish_3, radish_5, radish_6, radish_7, radish_8, radish_9], [stove], [celery]]
    initial_index_grouping =[[sink, radish_1, radish_2, radish_3, radish_5, radish_6, radish_7, radish_8, radish_4], [stove], [celery]]
...
def main():
    ...
    problem = pddlstream_from_problem(robot, body_path, grouping, surface, movable=movable, teleport=args.teleport)
