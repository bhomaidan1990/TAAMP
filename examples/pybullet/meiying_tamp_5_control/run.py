...
from examples.pybullet.utils.pybullet_tools.utils import WorldSaver, connect, dump_body, get_pose, set_pose, Pose, \
    ...
    BLOCK_URDF, CYAN_BLOCK_URDF, SHORT_SMALL_BLOCK_URDF, SHORT_HUGE_SMALL_BLOCK_URDF, get_configuration, SINK_URDF, STOVE_URDF, load_model, is_placement, get_body_name, \
...
def pddlstream_from_problem(robot, body_path, surface=[], movable=[], teleport=False, grasp_name='top'):
...
def main():
    ...
    problem = pddlstream_from_problem(robot, both_path, surface=surface, movable=movable, teleport=args.teleport)
